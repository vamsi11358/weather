...
export default function Dashboard() {
  ...
  const APIDATA = async()=> {
    const res = await axios.get('https://api.weatherbit.io/v2.0/forecast/daily?city=raleigh&country=USA&key=2e66da7c6a60473ebced954df194c935')
        ...
        <div className="relative isolate overflow-hidden pt-16">
          ...
          <header className="pb-4 pt-6 sm:pb-6">
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
              <h1 className="text-base font-semibold leading-7 text-gray-900">Weather</h1>
